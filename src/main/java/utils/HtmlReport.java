...
public class HtmlReport {
    ...
    public HtmlReport(String suiteName) {
        ...
        spark = new ExtentSparkReporter(URL_REPORT + suiteName + "\\ReporteEjecución.html").viewConfigurer().viewOrder()
                .as(new ViewName[] {
                        ViewName.DASHBOARD,
                        ViewName.CATEGORY,
                        ViewName.TEST,
        ...
        try {
            File json = new File(Constants.RUTA_CONFIG_HTML_REPORT+ "src\\main\\java\\utils\\htmlConfig.json");
